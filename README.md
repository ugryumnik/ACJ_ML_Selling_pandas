...
## Замечания
1. Код получился довольно объемным, причина заключается в использовании нейронной сети в решении. Можно использовать только один бустинг, тогда точность будет 77.51% AUC.  
